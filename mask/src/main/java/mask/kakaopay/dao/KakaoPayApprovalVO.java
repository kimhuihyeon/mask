...
public class KakaoPayApprovalVO {
	...
	public static KakaoPayApprovalVO getKakaoPayApprovalVO() {
		return kakaoPayApprovalVO;
	}
	public static void setKakaoPayApprovalVO(KakaoPayApprovalVO kakaoPayApprovalVO) {
		KakaoPayApprovalVO.kakaoPayApprovalVO = kakaoPayApprovalVO;
	}
