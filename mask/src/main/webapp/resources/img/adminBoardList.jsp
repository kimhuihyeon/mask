					...
					<div class="row">
							<div style="text-align:center;">
								<div id="dataTables-example_filter" class="dataTables_filter">
									<form id="frm" method="post" action="http://localhost:8888/mask/admin/SearchA.mk" >
				...
				$.each(data.list, function(key, value){
					str += "<tr>" + 
								...
								"<td>" + value.BOARD_DATE + "</td>" + 
 								...
 								"<td>" + value.BOARD_UP + "</td>" + 
 								"<td class='update'>" +
 								"<a href='#this' name='update'>" + value.BOARD_TITLE + "</a>" +
 								"<input type='hidden' name='title' id='BOARD_NUM' value=" + value.BOARD_NUM + ">" +
 								"</td>" +  
							"<td class='delete'>" +
							"<a href='#this' name='delete'>" + value.BOARD_NUM + "</a>" +
							"<input type='hidden' name='title' id='BOARD_NUM' value=" + value.BOARD_NUM + ">" +
							"</td>" +  
							"</tr>";
				});
