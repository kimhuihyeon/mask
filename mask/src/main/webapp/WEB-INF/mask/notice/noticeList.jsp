...
<body>
            ...
            <c:choose>
               <c:when test="${fn:length(list)>0}">
				...
				<tr>
					<td>${row.RNUM}</td>
					<td class="title">
                   <a href="#this" name="title">${row.BOARD_TITLE }</a>
				 ...
				 <c:otherwise>
         <tr>
         <td colspan="10"> 커뮤니티 작성 글이 없습니다.</td>
         </tr>
      </c:otherwise>
				</c:choose>
				</tbody>
	...
	$(document).ready(function(){
        ...
        function fn_openBoardDetail(obj){
            ...
            comSubmit.setUrl("<c:url value='/admin/noticeDetail.mk' />");
        ...
        function fn_selectBoardList(pageNo){
			...
			comAjax.setUrl("<c:url value='/admin/selectNoticeList.mk' />");
