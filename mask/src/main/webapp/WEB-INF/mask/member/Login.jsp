...
<body >
    ...
    <div class="container">
        ...
        <div class="right-conatiner">
            <label>SNS 로그인을 원하십니까?</label>
            <span><em>회원을</em> 위한 <em>다양한 혜택</em>이 준비되어있습니다.</span>
            <a href="/mask/Nlogin.mk">
            <img width="223" src="${pageContext.request.contextPath}/resources/images/Log_in_with_NAVER_Official_Green.PNG"/>
       </a>
        </div>
