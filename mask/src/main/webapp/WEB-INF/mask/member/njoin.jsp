                      ...
                      <div class="form_txtInput">
                        ...
                        <div class="join_form">
                          <table>
                            ...
                            <tbody>
                              <tr>
                                <th><span>아이디</span></th>
                             <td><input type="text" class="idCheck Eid" id="email2" name="MEM_ID"><br>
                              ...
                              <tr>
                                <th><span>이름</span></th>
                                <td><input type="text" placeholder="" id="name" class="Ename" name="MEM_NAME"><br>
                              ...
                              <tr class="email">
                                <th><span>이메일</span></th>
                                <td>
                                  <input type="text" class="Eemail" size="30"  id="email" name="MEM_EMAIL">
                              ...
                              <tr>
                                <th><span>휴대폰</span></th>
                                <td><input type="text" class="Ephone" id="mobile" name="MEM_PHONE"><br>
                        ...
                        <div class="agree_wrap">
                          <div class="checkbox_wrap">
                            <input type="checkbox" id="news_letter" name="MEM_EMAILCK" class="agree_chk" value="Y" checked="checked">
                            <label for="news_letter">[선택]뉴스레터 이메일 수신동의</label>
                          </div>
                          <div class="checkbox_wrap mar27">
                            <input type="checkbox" id="marketing" name="MEM_SNSCK" class="agree_chk" value="Y" checked="checked" >
