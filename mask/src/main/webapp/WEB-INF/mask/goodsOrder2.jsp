...
<input type="hidden" id="item_name" name="item_name" value="${map2.GOODS_NAME}">
...
<input type="hidden"  id="orderNumber" name="orderNumber" value="${map2.GOODS_NUM}">
<input type="hidden" id="GOODS_PRICE" name="GOODS_PRICE" value="${map2.GOODS_PRICE}"/>
...
$(document).ready(function() {
	...
	function fn_orderPay() {
		...
		var GOODS_NUM = "${map2.GOODS_NUM}";
		comSubmit.setUrl("<c:url value='/goodsOrderInsert.mk' />");
