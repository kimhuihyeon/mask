...
<form name="frm" id="frm" enctype="multipart/form-data" method="post" >
  ...
  <textarea id="GOODS_CONTENT" name="GOODS_CONTENT">
            ...
            <tr>
               ...
               <td>
                  <select name="GOODS_CATEGORY" style="width:200px;">
                     <option value="소형">s</option>
                     <option value="대형">m</option>
                     <option value="중형">l</option>
   ...
   <input type="button" value="목록으로" class="btn btn-outline-primary" onclick="location.href='http://localhost:8007/muscle/admin/openAdminGoods.do'">
   </div>   
